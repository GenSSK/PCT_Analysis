...
class PCT:
    ...
    def graph_sub(self):
        ...
        fig, (thm, wm, text) = plt.subplots(3, 1, figsize=(10, 10), sharex=True)
        ...
        text.plot(self.data['time'], self.data['i3_p_tdish'], label='Interface3')
        text.plot(self.data['time'], self.data['i4_p_tdish'], label='Interface4')
        ...
        plt.tight_layout()
        # plt.savefig("2021-11-08_bilateral_q.png")
        plt.show()
